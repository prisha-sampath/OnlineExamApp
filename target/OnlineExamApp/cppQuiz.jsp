...
<html>
<head>
    <title>C++ Quiz - Online Exam</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <%
        ...
        String[][] options = (String[][]) session.getAttribute("cppOptions");
    ...
    <div class="container">
        ...
        <form action="cppQuiz" method="post" id="quizForm">
            <%
            ...
            <div class="question-block">
                ...
                <%
                    for (int j = 0; j < options[i].length; j++) {
                        ...
                        String radioId = "c" + (i + 1) + String.valueOf((char)('a' + j));
                %>
                <div class="radio-group">
                    <input type="radio" id="<%= radioId %>" name="c<%= (i + 1) %>" value="<%= optionText %>">
